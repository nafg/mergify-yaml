...
object Action {
  ...
  case class Label(
    /** The list of labels to add.
      */
    add: Seq[ToJson /*Template*/],
    /** The list of labels to remove.
      */
    remove: Seq[ToJson /*Template*/],
  ...
  Default: null
      */
    method: Option[ToJson /*merge, rebase, squash or fast-forward or null*/] = None
  ) extends Action
  ...
  Default: true
      */
    allowMergingConfigurationChange: Option[Boolean] = None,
    /** This option is relevant only if you do in place checks and if you use the rebase option of the update_method. It
  ...
  Default: null
    ...
    mergeBotAccount: Option[ToJson /*Template or null*/] = None,
    /** Merge method to use. If no value is set, Mergify uses the first authorized method available in the repository
      * configuration. fast-forward is not supported on queues with speculative_checks > 1, batch_size > 1, or with
  ...
  Default: null
      */
    updateMethod: Option[ToJson /*rebase or merge or null*/] = None
  ) extends Action
