...
object Action {
  ...
  case class Backport(
      ...
      /** Essential Plan Feature 💪 Mergify can impersonate a GitHub user to backport a pull request. If no bot_account
  ...
  /** The comment action posts a comment to the pull request.
    */
  case class Comment(
      /** Essential Plan Feature 💪 Mergify can impersonate a GitHub user to comment a pull request. If no bot_account
